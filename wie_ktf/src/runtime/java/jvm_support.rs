...
impl KtfJvmSupport {
    ...
    pub fn register_scm2_fake_socket(
        ...
        // Do not rewrite SCM2 guest code here. The known-good PC runtime
        // boots the game with the seeded /certify file and program-name override
        // without version-check branch patching.
